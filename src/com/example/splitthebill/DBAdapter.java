...
public class DBAdapter {
	...
	public static final String[] ALL_KEYS = new String[] {KEY_ROWID, KEY_NAME, KEY_STUDENTNUM, KEY_FAVCOLOUR, KEY_STATUS};
	...
	public long insertRow(String name, int studentNum, String favColour, String status) {
		/*
		 * CHANGE 3:
		 */		
